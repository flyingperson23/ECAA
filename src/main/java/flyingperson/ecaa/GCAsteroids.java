...
public class GCAsteroids {
	...
	/**
	 * Register your blocks to use in asteroid cores during worldgen
	 * <br>
	 * 
	 * These are the default blocks that are set in Galacticraft, remove or add as needed
	 * but recommend to comment them out instead if removing in the case that you need to 
	 * revert a change.
	 * 
	 */
	...
	/**
	 * Register your blocks to use in asteroid shells during worldgen
	 * <br>
	 * 
	 * These are the default blocks that are set in Galacticraft, remove or add as needed
	 * but recommend to comment them out instead if removing in the case that you need to 
	...
	/**
	 * Register your blocks to use in asteroids that isn't part of our special core or shell parameters for worldgen
	 * <br>
	 * 
	 * These are the default blocks that are set in Galacticraft, remove or add as needed
	 * but recommend to comment them out instead if removing in the case that you need to 
