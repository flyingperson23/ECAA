...
public class ContainerExtractor extends ContainerMachineBase<ExtractorTileEntity> {

    public ContainerExtractor(InventoryPlayer playerInventory, ExtractorTileEntity machine) {
        super(machine);
